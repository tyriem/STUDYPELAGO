...
class IonRouteInner extends React__default['default'].PureComponent {
    render() {
        return (React__default['default'].createElement(reactRouter.Route, { path: this.props.path, exact: this.props.exact, render: this.props.render, computedMatch: this.props.computedMatch }));
    }
}
